    ...
    def isi(self):
        ...
        if l < len(loc_id):
            for iiii in loc_id:
                ...
                kriteria = [('picking_id.type','=','in'),('picking_id.state','=','done'),('picking_id.date','>=',self.date_from),('picking_id.date','<=',self.date_to),('picking_id.chk_import','=',True),('location_dest_id','=',iiii['location_id'])]
...
report_sxw.report_sxw('report.gdi.rekap_penerimaan_barang', 'stock.move', 'addons/telenais_pabean/report/rekap_penerimaan_barang.rml', parser=rekap_penerimaan_barang, header=False)
