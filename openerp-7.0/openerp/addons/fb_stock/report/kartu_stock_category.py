...
class kartu_stock_category(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(kartu_stock_category, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
        self.slip_ids = []
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(kartu_stock_category, self).set_context(objects, data, ids, report_type=report_type)

report_sxw.report_sxw('fb_stock.kartu_stock_category', 'stock.move', 'addons/fb_stock/report/kartu_stock_category.rml', parser=kartu_stock_category, header=False)
