...
class laporan_mutasi_barang_gb(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(laporan_mutasi_barang_gb, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
        self.isi_saldo = []
            ...
            for iiii in loc_id:
                ...
                for ii in cat:
                    ...
                    for product in obj_product.browse(self.cr, self.uid, product_ids):
                        ...
                        res = {
                            'nama_product': product.name or '',
                            'nama_uom': product.uom_id.name or '',
                            'default_code': product.default_code or '',
                            'qty_available': product.qty_available or '',
                            'category_name': product.categ_id.name or '',
                            'location_name': product.location_id.name or '',
                        }
                        res.update(result)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(laporan_mutasi_barang_gb, self).set_context(objects, data, ids, report_type=report_type)


report_sxw.report_sxw('report.laporan_mutasi_barang_gb', 'stock.move', 'addons/fb_stock/report/laporan_mutasi_barang_gb.rml', parser=laporan_mutasi_barang_gb, header=False)
