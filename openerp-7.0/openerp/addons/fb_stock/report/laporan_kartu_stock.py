...
class laporan_kartu_stock(report_sxw.rml_parse):
    ...
    def get_location_name(self, form):
        ...
        kriteria = [('id','=', form['location_id'][0]) ]
    ...
    def saldo(self,form):
        ...
        self.cr.execute("   SELECT \
                            ...
                            ", (form['location_id'][0], form['date_from'], form['date_to'],
                                ...
                                form['location_id'][0], form['location_id'][0], form['product_id'][0],
...
report_sxw.report_sxw('report.laporan_kartu_stock', 'stock.move', 'addons/fb_stock/report/laporan_kartu_stock.rml', parser=laporan_kartu_stock, header=False)
