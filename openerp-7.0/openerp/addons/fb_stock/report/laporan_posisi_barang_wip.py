...
class laporan_posisi_barang_wip(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(laporan_posisi_barang_wip, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
        self.isi_saldo = []
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(laporan_posisi_barang_wip, self).set_context(objects, data, ids, report_type=report_type)


report_sxw.report_sxw('report.laporan_posisi_barang_wip', 'stock.move', 'addons/fb_stock/report/laporan_posisi_barang_wip.rml', parser=laporan_posisi_barang_wip, header=False)
