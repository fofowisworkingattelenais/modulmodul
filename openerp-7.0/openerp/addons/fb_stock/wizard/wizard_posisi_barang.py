...
class wizard_posisi_barang(osv.osv_memory):
	_name = 'fb_stock.wizard_posisi_barang'
	_description = 'Wizard Posisi Barang Per Dokumen'
	...
	def cetak_laporan(self, cr, uid, ids, context=None):
		...
		return	{
				...
				'report_name' : 'laporan_posisi_barang',
				'datas' : datas
				}
