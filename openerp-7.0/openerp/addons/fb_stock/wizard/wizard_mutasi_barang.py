...
class wizard_mutasi_barang(osv.osv_memory):
	_name = 'fb_stock.wizard_mutasi_barang'
	_description = 'Wizard Pertanggungjawaban Mutasi Barang'
	...
	def cetak_laporan(self, cr, uid, ids, context=None):
		...
		return	{
				...
				'report_name' : 'laporan_mutasi_barang',
				'datas' : datas
				}    						
    

wizard_mutasi_barang()
