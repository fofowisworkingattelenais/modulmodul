...
report_sxw.report_sxw('report.loista_piutang_report', 'account.invoice','addons/loista/report/loista_piutang_report.rml',parser=loista_piutang_report, header=False)
