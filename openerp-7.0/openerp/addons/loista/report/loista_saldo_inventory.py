...
class loista_saldo_inventory(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(loista_saldo_inventory, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
        self.isi_saldo = []
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(loista_saldo_inventory, self).set_context(objects, data, ids, report_type=report_type)


report_sxw.report_sxw('report.loista_saldo_inventory', 'stock.move', 'addons/loista/report/loista_saldo_inventory.rml', parser=loista_saldo_inventory, header=False)
