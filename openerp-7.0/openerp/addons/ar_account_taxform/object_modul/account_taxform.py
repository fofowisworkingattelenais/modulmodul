...
class account_taxform(osv.osv):
    ...
    _columns = 	{
        ...
        'company_address' : fields.many2one(obj='res.partner', string='Company Address', required=True),
        ...
        'partner_address_id' : fields.many2one(obj='res.partner', string='Partner Address', required=True),
        ...
        'kurs_pajak': fields.float(string='Kurs Pajak', digits_compute=dp.get_precision('Account'), required=False),
        'result_pajak': fields.float(string='Base USD-IDR', digits_compute=dp.get_precision('Account'), required=False),
        'result_pajak_ppn': fields.float(string='Amount Tax USD-IDR', digits_compute=dp.get_precision('Account')),
