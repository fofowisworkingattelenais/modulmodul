...
class stock_inventory_line(osv.osv):
    ...
    _columns = {
        ...
        'stok_awal': fields.float('Stok Awal' ),
        'keterangan': fields.char('Keterangan' , size=64),
    ...
    def on_change_product_id(self, cr, uid, ids, location_id, product, uom=False, to_date=False):
        ...
        awal = self.pool.get('stock.location')._product_get(cr, uid, location_id, [product], {'uom': uom, 'to_date': to_date})[product]
        amount = self.pool.get('stock.location')._product_get(cr, uid, location_id, [product], {'uom': uom, 'to_date': to_date})[product]
        result = {'product_qty': amount, 'stok_awal': awal, 'product_uom': uom}
        return {'value': result}
...
class stock_warehouse(osv.osv):
    ...
    _columns = {
        ...
        'project_id': fields.many2one(string='Project', obj='project.project', readonly=False,
                                      states={'draft': [('readonly', False)]}),
