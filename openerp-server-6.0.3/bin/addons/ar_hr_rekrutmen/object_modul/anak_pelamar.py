...
class anak_pelamar(osv.osv):
	_name = 'hr.anak_pelamar'
	_description = 'Anak Pelamar'
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(anak_pelamar, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(anak_pelamar, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(anak_pelamar, self).unlink(cr, uid, ids, context)
		else:
