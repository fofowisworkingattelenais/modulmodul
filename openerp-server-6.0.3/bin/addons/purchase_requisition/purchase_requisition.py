...
class purchase_requisition(osv.osv):
    ...
    def onchange_order_id(self, cr, uid, ids, order_id, po_date_order, context=None):
        value = {'po_date_order': ''}
        if order_id:
            prod = self.pool.get('purchase.order').browse(cr, uid, order_id, context=context)
            value = {'date_order': prod.date_order,'po_date_order':prod.date_order}
        return {'value': value}
...
class purchase_requisition_line(osv.osv):
    ...
    _columns = {
        ...
        'po_date_order': fields.date('Order Date', readonly=True, states={'draft': [('readonly', True)]}),
        'date_start': fields.date('Requisition Date'),
    }
        ...
        for po in self.browse(cr, uid, ids, context=context):
            if po.requisition_id and (po.requisition_id.exclusive=='exclusive'):
                for order in po.requisition_id.purchase_ids:
                    ...
                    requisition_obj.write(cr, uid, [po.requisition_id.id], {'state':'done',
