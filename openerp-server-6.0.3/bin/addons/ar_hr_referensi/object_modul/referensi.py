...
class referensi(osv.osv):
	_name = "hr.referensi"
	_description = "Referensi"
	...
	_columns = 	{
				...
				'telepon' : fields.char('Telepon', size=100),
				'pekerjaan' : fields.char('Pekerjaan', size=255),
				}	
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(referensi, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(referensi, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(referensi, self).unlink(cr, uid, ids, context)
		else:
