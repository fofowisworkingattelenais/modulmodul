...
class kerabat(osv.osv):
	_name = "hr.kerabat"
	_description = "Kerabat"
	
	_columns = 	{
				'employee_id' : fields.many2one('hr.employee', 'Karyawan', required = True),
				'name' : fields.many2one('hr.employee', 'Kerabat', required = True),
				'hubungan' : fields.char('Hubungan', size=100, required=True),
				}	
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(kerabat, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(kerabat, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(kerabat, self).unlink(cr, uid, ids, context)
		else:
