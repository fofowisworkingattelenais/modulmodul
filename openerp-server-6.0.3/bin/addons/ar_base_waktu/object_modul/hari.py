...
class hari(osv.osv):
	...
	_description = 'hari'
	_columns = 	{
				'name' : fields.char(string='Hari', size=100, required=True),
				'kode' : fields.char(string='Kode', size=2, required=True),
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(hari, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(hari, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(hari, self).unlink(cr, uid, ids, context)
		else:
