...
class jenis_kelamin(osv.osv):
    _name="identitas.jenis_kelamin"
    _description ="Jenis Kelamin"
    _columns={
            'kode':fields.char('Kode',size=30),
            'name':fields.char('Jenis Kelamin',size=100,required=True),
            }
    def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(jenis_kelamin, self).create(cr, uid, values, context)
		else:
    ...
    def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(jenis_kelamin, self).copy(cr, uid, id, default, context)
		else:
    ...
    def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(jenis_kelamin, self).unlink(cr, uid, ids, context)
		else:
