...
class status_pekerjaan(osv.osv):
    _name="identitas.status_pekerjaan"
    _description ="Status Pekerjaan"
    _columns={
            'kode':fields.char('Kode',size=30),
            'name':fields.char('Status Pekerjaan',size=100,required=True),
            }
    ...
    def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(status_pekerjaan, self).create(cr, uid, values, context)
		else:
    ...
    def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(status_pekerjaan, self).copy(cr, uid, id, default, context)
		else:
    ...
    def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(status_pekerjaan, self).unlink(cr, uid, ids, context)
		else:
