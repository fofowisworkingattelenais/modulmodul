...
class golongan_darah (osv.osv):
	_name = 'identitas.golongan_darah'
	_description = 'Golongan Darah'
	_columns = {
		'kode' : fields.char('Kode', size=30),
		'name' : fields.char('Golongan Darah', size=100, required=True),
	}
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(golongan_darah, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(golongan_darah, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(golongan_darah, self).unlink(cr, uid, ids, context)
		else:
