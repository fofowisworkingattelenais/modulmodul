...
class etnis (osv.osv):
	_name = 'identitas.etnis'
	_description = 'Etnis'
	_columns = {
		'kode' : fields.char('Kode', size=30),
		'name' : fields.char('Etnis', size=100, required=True),
	}
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(etnis, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(etnis, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(etnis, self).unlink(cr, uid, ids, context)
		else:
