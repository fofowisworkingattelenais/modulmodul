...
class pendidikan_non_formal(osv.osv):
	_name = 'hr.pendidikan_non_formal'
	_description = 'Pendidikan Non Formal Karyawan'
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(pendidikan_non_formal, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(pendidikan_non_formal, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(pendidikan_non_formal, self).unlink(cr, uid, ids, context)
		else:
