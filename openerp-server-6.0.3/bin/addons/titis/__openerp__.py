...

{
    ...
    'update_xml': [ 
                    ...
                    #'view/view_PeringatanKaryawan.xml',
                    ...
                    #'board/board_kepegawaian.xml',
                    #'board/board_KepegawaianHistory.xml',
                    'menu/menu_account.xml',
                    'menu/menu_stock.xml',
                    'menu/menu_sale.xml',
                    'menu/menu_purchase.xml',
                    'menu/menu_administration.xml',
                    #'menu/menu_kepegawaian.xml',
                    'menu/menu_board.xml',],
    'demo_xml': [],
    'test': [],
    'installable': True,
