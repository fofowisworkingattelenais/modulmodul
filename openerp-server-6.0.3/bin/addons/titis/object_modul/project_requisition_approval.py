...
class project_requisition_approval(osv.osv):
	_name = 'titis.project_requisition_approval'
	_description = 'Project Purchase Requisition Approval'
	_columns =	{
