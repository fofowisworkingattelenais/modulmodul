...
class cash_payment(osv.osv):
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(cash_payment, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(cash_payment, self).unlink(cr, uid, ids, context)
	...
	def button_workflow_action_ready(self, cr, uid, ids, context={}):
		...
		if project_id:
			...
			if project.cash_payment_approval_ids:
				for approval in project.cash_payment_approval_ids:
					res =	{
									'name' : approval.name,
