...
class invoice_approval(osv.osv):
	_name = 'titis.invoice_approval'
	...
	def button_action_approved(self, cr, uid, ids, context={}):
		...
		for approval in self.browse(cr, uid, ids):
			...
			wkf_service.trg_validate(uid, 'account.invoice', approval.voucher_id.id, 'button_ready', cr)	
			obj_invoice.write(cr, uid, [approval.voucher_id.id], {})	
		return True
