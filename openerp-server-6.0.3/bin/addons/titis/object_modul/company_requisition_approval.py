...
class company_requisition_approval(osv.osv):
	_name = 'titis.company_requisition_approval'
	_description = 'Company Purchase Requisition Approval'
	_columns =	{
