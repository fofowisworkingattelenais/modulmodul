...
class cash_receipt(osv.osv):
	_name = 'titis.cash_receipt'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(cash_receipt, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(cash_receipt, self).unlink(cr, uid, ids, context)
	...
	def button_workflow_action_ready(self, cr, uid, ids, context={}):
		...
		if project_id:
			...
			if project.cash_receipt_approval_ids:
				for approval in project.cash_receipt_approval_ids:
					res =	{
									'name' : approval.name,
