...
class cash_receipt(report_sxw.rml_parse):


    def __init__(self, cr, uid, name, context):
        super(cash_receipt, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.cash_receipt','titis.cash_receipt','addons/titis/report/cash_receipt.rml',parser=cash_receipt, header=False)
