...
from titis.report.laporan_uang_muka  import laporan_uang_muka
...
class laporan_uang_muka_excel(report_xls, laporan_uang_muka):
...
laporan_uang_muka('report.pl.account.excel', 'account.account', 'addons/account/report/account_profit_loss_excel.mako', parser=ReportStatus, header=False)
