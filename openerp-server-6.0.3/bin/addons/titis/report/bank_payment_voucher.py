...
class bank_payment_voucher(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        super(bank_payment_voucher, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.bank_payment_voucher','titis.bank_payment','addons/titis/report/bank_payment_voucher.rml',parser=bank_payment_voucher, header=False)
