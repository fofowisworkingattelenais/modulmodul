...
class cash_payment_voucher(report_sxw.rml_parse):


    def __init__(self, cr, uid, name, context):
        super(cash_payment_voucher, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.cash_payment_voucher','titis.cash_payment','addons/titis/report/cash_payment_voucher.rml',parser=cash_payment_voucher, header=False)
