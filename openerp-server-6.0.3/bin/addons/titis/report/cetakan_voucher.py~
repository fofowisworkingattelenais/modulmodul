...
class cetakan_voucher(report_sxw.rml_parse):


    def __init__(self, cr, uid, name, context):
        super(cetakan_voucher, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.cetakan_voucher','titis.bank_payment','addons/titis/report/cetakan_voucher.rml',parser=cetakan_voucher, header=False)
