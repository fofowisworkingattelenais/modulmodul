...
class laporan_account_payable_aging_by_vendor(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(laporan_account_payable_aging_by_vendor, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
    ...
    def lines(self, form):
        ...
        kriteria = ['|',('date_due','<',form['tanggal']),('date_invoice','<',form['tanggal']),('type','=', 'in_invoice'),('state','=','open'),('partner_id','=',form['partner_id'])]
...
report_sxw.report_sxw('report.laporan_account_payable_aging_by_vendor', 'account.invoice','addons/titis/report/laporan_account_payable_aging_by_vendor.rml',parser=laporan_account_payable_aging_by_vendor, header=False)
