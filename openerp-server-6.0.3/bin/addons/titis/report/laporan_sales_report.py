...
class laporan_sales_report(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):

        super(laporan_sales_report, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
        self.tanggal_mulai = ''
        self.tanggal_akhir = ''
    ...
    def lines (self, form):
        ...
        invoice_ids = obj_invoice.search(self.cr, self.uid, [('type', '=', 'out_invoice'), ('date_invoice','>=',form['tanggal_mulai']), ('date_invoice','<=',form['tanggal_akhir']), ('state','in',('open','paid'))])
...
report_sxw.report_sxw('report.laporan_sales_report', 'account.invoice','addons/titis/report/laporan_sales_report.rml',parser=laporan_sales_report, header=False)
