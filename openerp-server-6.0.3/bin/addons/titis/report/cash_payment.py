...
class cash_payment(report_sxw.rml_parse):


    def __init__(self, cr, uid, name, context):
        super(cash_payment, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.cash_payment','titis.cash_payment','addons/titis/report/cash_payment.rml',parser=cash_payment, header=False)
