...
class bank_payment(report_sxw.rml_parse):


    def __init__(self, cr, uid, name, context):
        super(bank_payment, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.bank_payment','titis.bank_payment','addons/titis/report/bank_payment.rml',parser=bank_payment, header=False)
