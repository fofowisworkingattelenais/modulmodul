...
class laporan_account_receivable(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):

        super(laporan_account_receivable, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
    ...
    def lines(self, form):
        ...
        kriteria = ['|',('date_due','<',form['tanggal']),('date_invoice','<',form['tanggal']),('type','=', 'out_invoice'),('state','=','open')]
...
report_sxw.report_sxw('report.laporan_account_receivable', 'account.invoice','addons/titis/report/laporan_account_receivable.rml',parser=laporan_account_receivable, header=False)
