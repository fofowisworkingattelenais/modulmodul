...
class laporan_actual_vs_budget(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):

        super(laporan_actual_vs_budget, self).__init__(cr, uid, name, context=context)
        self.isi_laporan = []
...
report_sxw.report_sxw('report.laporan_actual_vs_budget', 'account.account','addons/titis/report/laporan_actual_vs_budget.rml',parser=laporan_actual_vs_budget, header=False)
