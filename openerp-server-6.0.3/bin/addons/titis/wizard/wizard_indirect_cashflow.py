...
class wizard_indirect_cashflow(osv.osv_memory):
    _name = 'titis.wizard_indirect_cashflow'
    _description = 'Wizard Indirect Cashflow'
    ...
    def print_report(self, cr, uid, ids, data, context=None):
        ...
        return {
            ...
            'report_name': 'laporan.indirect.cashflow',
            'datas': datas,
        }


wizard_indirect_cashflow()
