...
class anak_karyawan(osv.osv):
	_name = "hr.anak_karyawan"
	_description = "Anak Karyawan"
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(anak_karyawan, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(anak_karyawan, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(anak_karyawan, self).unlink(cr, uid, ids, context)
		else:
