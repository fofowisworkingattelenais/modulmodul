...
class masa_pajak(osv.osv):
	...
	_columns = 	{
				'name' : fields.char('Masa Pajak', size=30, required=True),
				'kode' : fields.char('Kode', size=30, required=True),
				'tahun_pajak_id' : fields.many2one('pajak.tahun_pajak', 'Tahun Pajak', required=True),
				'tanggal_mulai' : fields.date('Tanggal Mulai', required=True),
				'tanggal_akhir' : fields.date('Tanggal Akhir', required=True),
				'sequence' : fields.integer('Urutan'),
