...
class order_external(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context):
		super(order_external, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.purchase.order.external','purchase.order','addons/telenais_gdi/report/purchase_order_external.rml',parser=order_external, header=False)
