...
class rfq_internal(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context):
		super(rfq_internal, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.purchase.rfq.internal','purchase.order','addons/telenais_gdi/report/rfq_internal.rml',parser=rfq_internal, header=False)
