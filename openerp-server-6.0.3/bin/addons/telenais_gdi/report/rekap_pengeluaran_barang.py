...
report_sxw.report_sxw('report.gdi.rekap_pengeluaran_barang', 'stock.move', 'addons/telenais_gdi/report/rekap_pengeluaran_barang.rml', parser=rekap_pengeluaran_barang, header=False)
