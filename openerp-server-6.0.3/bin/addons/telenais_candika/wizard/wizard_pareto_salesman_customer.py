...
class wizard_pareto_salesman_customer(osv.osv_memory):
	_name = 'candika.wizard_pareto_salesman_customer'
	_description = 'Wizard Pareto Salesman/Customer'
...
wizard_pareto_salesman_customer()
